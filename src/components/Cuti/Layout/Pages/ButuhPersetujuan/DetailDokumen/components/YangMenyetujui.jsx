        ...
        <Box sx={{minHeight: '300px', height:'100%', backgroundColor: 'white', borderRadius: 2, boxShadow: '1px 6px 8px rgba(0, 0, 0, 0.1)'}}>
            <Stack direction= 'column'>
                <Box sx={{borderRadius: "2px 2px 0px 0px", backgroundColor: '#D6E0FF', paddingY: 2, paddingX: 3}}>
                    <Typography sx={{fontSize:'20px', color:'#1F3D99', fontFamily:style.fontFamily, fontWeight: '700'}}> Yang menyetujui </Typography>
                </Box>
                <Stack direction={'column'} sx={{paddingY: 2, paddingX: 2}} spacing={2}>
                    {DataPenyetuju.map((item) => (
