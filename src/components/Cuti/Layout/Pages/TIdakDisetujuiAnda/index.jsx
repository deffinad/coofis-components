...
import { DataTidakDisetujuiAnda } from './DocsTidakDisetujuiAnda';
import { scrollbar } from '../../utils/scrollbar';

const TidakDisetujuiAnda = () => {
    ...
    return (
        <Box p={5}>
            <Stack direction='column' p={4} spacing = {4} sx={{...scrollbar('#9E9E9E'), maxHeight:'100%', overflow: "auto", backgroundColor:'white', borderRadius:3}}>
                ...
                <GenerateTable config={DataTidakDisetujuiAnda}></GenerateTable>
            </Stack>
        </Box>
    )
}

export default TidakDisetujuiAnda