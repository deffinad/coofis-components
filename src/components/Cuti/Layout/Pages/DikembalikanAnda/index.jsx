...
import { DataDikembalikanAnda } from './DocsDikembalikanAnda';
import { scrollbar } from '../../utils/scrollbar';

const DikembalikanAnda = () => {
    ...
    return (
        <Box p={5}>
            <Stack direction='column' p={4} spacing = {4} sx={{...scrollbar('#9E9E9E'), maxHeight:'100%', overflow: "auto", backgroundColor:'white', borderRadius:3}}>
                ...
                <GenerateTable config={DataDikembalikanAnda}></GenerateTable>
            </Stack>
        </Box>
    )
}

export default DikembalikanAnda