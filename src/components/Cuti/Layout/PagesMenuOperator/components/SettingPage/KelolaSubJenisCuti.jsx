...
const KelolaSubJenisCuti = ({config}) => {

    return (
        <Box p={4}>
            <Box sx={{ maxHeight:'100%', backgroundColor:'white', borderRadius:3}}>
                <Stack p = {4} direction='column' spacing = {2}>
                    <Typography fontFamily={style.fontFamily} color='black' fontWeight={'700'} fontSize={20}>Kelola Sub Jenis Cuti</Typography>
...
export default KelolaSubJenisCuti