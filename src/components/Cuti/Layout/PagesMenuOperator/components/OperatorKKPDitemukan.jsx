...
const OperatorKKPDitemukan = ({config}) => {
    const style = stylingConfig[0]

    return (
        <Box sx={{ maxHeight:'100%', backgroundColor:'white', borderRadius:3}}>
            <Stack direction='column' spacing = {4}>
                <Typography fontFamily={style.fontFamily} color='black' fontWeight={'600'} fontSize={20}>Pegawai yang ditemukan</Typography>
...
export default OperatorKKPDitemukan